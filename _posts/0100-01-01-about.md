...
* Indicative maps are available in a data repository:
  > Keith, David A., Ferrer-Paris, Jose R., Nicholson, Emily, & Kingsford, Richard T. (eds.) (2023). *Indicative distribution maps for Ecosystem Functional Groups - Level 3 of IUCN Global Ecosystem Typology (Version 2.1.3)* [Data set]. **Zenodo**. DOI: [10.5281/zenodo.3546513](http://doi.org/10.5281/zenodo.3546513)
...
* Additional map documentation and other related resources are available at this [info site](https://red-list-ecosystem.github.io/typology-map-info/).
