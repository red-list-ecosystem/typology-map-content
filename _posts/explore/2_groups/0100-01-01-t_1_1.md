...
The distribution of tropical and subtropical dry forest was approximated from a model of the spatial distribution of terrestrial habitat types (Class *1.6. Forest – Subtropical/tropical moist lowland* in: Jung et al. 2020). Occurrences were aggregated to half degree spatial resolution and cells reclassified as major occurrences (>25%) and minor occurrences (< 25%) .
