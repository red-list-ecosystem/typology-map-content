...
**Citation**: RT Kingsford, B Robson, M Kelly-Quinn and DA Keith. (2020). 'F3.5 Canals, ditches and drains'. In: Keith, D.A., Ferrer-Paris, J.R., Nicholson, E. and Kingsford, R.T. (eds.) (2020). The IUCN Global Ecosystem Typology 2.0: Descriptive profiles for biomes and ecosystem functional groups. Gland, Switzerland: IUCN.

**Content version**: v2.0, updated 2020-06-18.

**Map version**: F3.5.web.orig v1.0, updated 2020-10-19.
